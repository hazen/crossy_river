...
%%% @copyright (C) 2018
%%% @doc
%%% Simple driver for reading the state files, parsing arguments and
%%% launching the application, which does the real work.
%%% @end
%%%-------------------------------------------------------------------
-module(crossy_river).
...
%% @private
%% @doc
%% Start the statem with the correct configuration
%% @end
%%--------------------------------------------------------------------
...
%% @private
%% @doc
%% Wait until the statem is in a completed state by retrying N times
%% @end
%%--------------------------------------------------------------------
...
%% @private
%% @doc
%% Set either the default state and moves or read from a file
%% @end
%%--------------------------------------------------------------------
...
%% @private
%% @doc
%% Load the replay file of the format:
%%   <initial state>
%%   <move 1>
%%    ...
%%   <move n>
...
%% @private
%% @doc
%% Set up the names of the items and rules about who eats whom
...
%% @private
%% @doc
%% Load the customization file described in parse_custom_record
%% @end
%%--------------------------------------------------------------------
...
%% @private
%% @doc
%% Parse a single record in the customization file which defines both
...
%% @private
%% @doc
%% Translate a string into a tuple for each river bank. Internally the river
%% representation is implied by two record fields.
%% @end
%%--------------------------------------------------------------------
